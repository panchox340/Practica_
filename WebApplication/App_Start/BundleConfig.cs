    ...
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new StyleBundle("~/AdminLTE/css").Include(
                                         ...
                                         "~/Styles/iziToast-master/iziToast.min.css",
 										 "~/AdminLTE/plugins/daterangepicker/css/daterangepicker-bs3.css",
                                         "~/AdminLTE/plugins/file_plugin/css/fileinput.min.css",
                                         "~/iziToast-master"));
            ...
            bundles.Add(new ScriptBundle("~/AdminLTE/js").Include(
                                         ...
                                         "~/Scripts/Notification/iziToast-master/iziToast.min.js",
                                         ...
                                         "~/AdminLTE/plugins/file_plugin/js/fileinput.min.js",
                                         "~/AdminLTE/plugins/jquery_rut/jquery.rut.min.js",
                                         "~/Scripts/custom.js"));
        ...
        private static void RegisterLayout(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/AdminLTE/bootstrap/js").Include(
                "~/AdminLTE/bootstrap/js/bootstrap.min.js"));
//
            bundles.Add(new StyleBundle("~/Styles/AdminLTE/bootstrap/css").Include(
            ...
            bundles.Add(new ScriptBundle("~/AdminLTE/dist/js").Include(
                "~/AdminLTE/dist/js/app.js"));
//            
            bundles.Add(new StyleBundle("~/Styles/AdminLTE/dist/css").Include(
                "~/Styles/AdminLTE/dist/css/admin-lte.min.css"));
//
            bundles.Add(new StyleBundle("~/Styles/AdminLTE/dist/css/skins").Include(
...
//
            ...
            bundles.Add(new StyleBundle("~/Styles/AdminLTE/plugins/font-awesome/css").Include(
                                        "~/Styles/AdminLTE/plugins/font-awesome/css/font-awesome.min.css"));

            // plugins | fullcalendar
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/fullcalendar/js").Include(
                                         "~/AdminLTE/plugins/fullcalendar/js/fullcalendar.min.js"));
//
            bundles.Add(new StyleBundle("~/Styles/AdminLTE/plugins/fullcalendar/css").Include(
                                        "~/Styles/AdminLTE/plugins/fullcalendar/css/fullcalendar.min.css"));
...
//
            // plugins | ionicons
            bundles.Add(new StyleBundle("~/Styles/AdminLTE/plugins/ionicons/css").Include(
                                        "~/Styles/AdminLTE/plugins/ionicons/css/ionicons.min.css"));
            ...
            // plugins | morris
            bundles.Add(new ScriptBundle("~/Scripts/dminLTE/plugins/morris/js").Include(
                                         "~/AdminLTE/plugins/morris/js/morris.min.js"));

            // plugins | iziToast-master
            bundles.Add(new ScriptBundle("~/Scripts/Scripts/Notification/iziToast-master").Include(
                                         "~/Scripts/Notification/iziToast-master/iziToast.min.js"));

            bundles.Add(new StyleBundle("~/Styles/iziToast-master").Include(
                                        "~/Styles/iziToast-master/iziToast.min.css"));

            // plugins | bootstrap file input
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/file_plugin/js").Include(
                                        "~/AdminLTE/plugins/file_plugin/js/fileinput.min.js"));

            bundles.Add(new StyleBundle("~/AdminLTE/plugins/file_plugin/css").Include(
                                        "~/AdminLTE/plugins/file_plugin/css/fileinput.min.css"));

            //plugins | jquery rut validador
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/jquery_rut").Include(
                                        "~/AdminLTE/plugins/jquery_rut/jquery.rut.min.js"));
        }
    }
}
